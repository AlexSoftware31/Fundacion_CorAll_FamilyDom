...
import { dataRows, sections } from "./CookiesData";
        ...
        >
          ...
          <div className="px-6 py-4">
            <p className="mb-5 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
              Las cookies son pequeños archivos que se descargan en el dispositivo del usuario al acceder a una página web. Permiten almacenar y recuperar información sobre la navegación, con el fin de mejorar la experiencia del usuario.
            </p>
