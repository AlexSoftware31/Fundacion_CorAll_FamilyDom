const dataRows = [
  ...
  { label: "N.º de registro", value: "00000002" },
  ...
  },
  {
    label: "Actividad",
    value:
      "Información, orientación y difusión de contenido relacionado con las cardiopatías congénitas, su diagnóstico, tratamiento y programas de apoyo social.",
  },
];
...
const sections = [
  ...
  },
  {
    ...
    body: "El usuario se compromete a hacer un uso adecuado del sitio web conforme a la ley, la moral, el orden público y el presente Aviso Legal. Queda prohibido: Utilizar el sitio web con fines ilícitos o fraudulentos. Introducir o difundir contenidos falsos, ofensivos o que vulneren derechos de terceros. Realizar actividades que puedan dañar, sobrecargar o deteriorar el funcionamiento del sitio web. El usuario será responsable de la veracidad de los datos que proporcione a través de los formularios del sitio.",
  },
  {
    number: "4",
  ...
  },
  {
    ...
    body: "Este sitio web puede utilizar cookies para mejorar la experiencia del usuario. El usuario puede configurar su navegador para aceptar o rechazar el uso de cookies. Para más información, puede consultar nuestra Política de Cookies.",
  },
  {
    number: "9",
    title: "Legislación aplicable y jurisdicción",
    body: "El presente Aviso Legal se rige por las leyes de la República Dominicana. Para cualquier controversia que pudiera derivarse del acceso o uso del sitio web, las partes se someterán a los tribunales competentes de la República Dominicana.",
  },
];
