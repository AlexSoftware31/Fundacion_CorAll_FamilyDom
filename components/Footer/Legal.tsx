...
import { dataRows, sections } from "./LegalData";
      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          ...
          <div className="px-6 py-4">
            <p className="mb-5 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
              En cumplimiento de lo dispuesto en la Ley No. 122-05 sobre
              Regulación y Fomento de las Asociaciones Sin Fines de Lucro en la
              República Dominicana, se informa que el presente sitio web es
              titularidad de:
            </p>
            ...
            <div className="divide-y divide-gray-100 dark:divide-strokedark">
             ...
             <p className="mb-5 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
              El acceso y uso de este sitio web atribuye la condición de usuario, lo que implica la aceptación plena de las condiciones establecidas en este Aviso Legal.
            </p>
          </div>
        </motion.div>
        ...
        >
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Para cualquier duda sobre este Aviso Legal, el usuario puede contactar a través del correo electrónico.
          </p>
          <a
