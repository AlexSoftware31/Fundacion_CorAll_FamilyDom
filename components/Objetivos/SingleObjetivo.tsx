...
const SingleObjetivo = ({ feature }: { feature: Feature }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <Image src={icon} width={200} height={160} alt="title" />
        <h3 className="xl:text-itemtitle mt-7.5 mb-5 text-xl font-semibold text-amber-600 dark:text-white">
          {title}
        </h3>
        <p>{description}</p>
